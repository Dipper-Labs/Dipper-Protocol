...
import (
	...
	store "github.com/Dipper-Labs/Dipper-Protocol/store/types"
...
func registerTestCodec(cdc *codec.Codec) {
	...
	cdc.RegisterConcrete(&txTest{}, "dip/codec/baseapp/txTest", nil)
	cdc.RegisterConcrete(&msgCounter{}, "dip/baseapp/msgCounter", nil)
	cdc.RegisterConcrete(&msgCounter2{}, "dip/baseapp/msgCounter2", nil)
	cdc.RegisterConcrete(&msgNoRoute{}, "dip/baseapp/msgNoRoute", nil)
}
...
func TestRunInvalidTransaction(t *testing.T) {
	...
	// Transaction with an unregistered message
	{
		...
		newCdc.RegisterConcrete(&msgNoDecode{}, "dip/baseapp/msgNoDecode", nil)
