...
```bash
go test -v --bench github.com/Dipper-Labs/Dipper-Protocol/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/Dipper-Labs/Dipper-Protocol/crypto/keys/mintkey
...
PASS
ok  	github.com/Dipper-Labs/Dipper-Protocol/crypto/keys/mintkey	12.093s
```
