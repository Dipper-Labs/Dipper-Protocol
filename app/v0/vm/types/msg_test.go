...
func TestMsgContractGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"dip/MsgContract","value":{"amount":{"amount":"123","denom":"pdip"},"from":"dip1veex7mgqds9ht","payload":"7061796c6f6164","to":""}}`
	...
	res = msg.GetSignBytes()
	expected = `{"type":"dip/MsgContract","value":{"amount":{"amount":"123","denom":"pdip"},"from":"dip1veex7mgqds9ht","payload":"7061796c6f6164","to":"dip1w3hsyjkh49"}}`
	require.Equal(t, expected, string(res))
