...
Example:
$ %s tx staking delegate dipvaloper1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm 1000pdip --from mykey
`,
				version.ClientName,
			),
		),
...
Example:
$ %s tx staking redelegate dipvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj dipvaloper1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm 100ustake --from mykey
`,
				version.ClientName,
			),
		),
...
Example:
$ %s tx staking unbond dipvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj 100pdip --from mykey
`,
				version.ClientName,
			),
		),
