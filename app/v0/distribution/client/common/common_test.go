...
func TestQueryDelegationRewardsAddrValidation(t *testing.T) {
	...
	tests := []struct {
		...
		{"invalid validator address", args{"dip169j6jw5lv9l76zdqxqcgzz84yrtsu2r7w5s2dg", "invalid"}, nil, true},
		{"empty validator address", args{"dip169j6jw5lv9l76zdqxqcgzz84yrtsu2r7w5s2dg", ""}, nil, true},
	}
