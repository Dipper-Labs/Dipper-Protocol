...
import (
	...
	"github.com/Dipper-Labs/Dipper-Protocol/app/v0/distribution/client/common"
...
Example:
$ %s query distr validator-outstanding-rewards dipvaloper1lwjmdnks33xwnmfayc64ycprww49n33mtm92ne
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query distr commission dipvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query distr slashes dipvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj 0 100
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query distr rewards dip1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p
$ %s query distr rewards dip1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p dipvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`,
