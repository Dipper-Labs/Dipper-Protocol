...
func TestMsgSetNameGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"dipperProtocol/SetName","value":{"name":"maTurtle","owner":"cosmos1d4js690r9j","value":"1"}}`
...
func TestMsgBuyNameGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"dipperProtocol/BuyName","value":{"bid":[{"amount":"10","denom":"atom"}],` +
...
func TestMsgDeleteNameGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"dipperProtocol/DeleteName","value":{"name":"maTurtle","owner":"cosmos1d4js690r9j"}}`
