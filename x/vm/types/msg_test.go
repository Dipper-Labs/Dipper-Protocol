...
func TestMsgContractGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"dip/MsgContract","value":{"amount":{"amount":"123","denom":"pdip"},"from":"nch1veex7mg3k0xqr","payload":"7061796c6f6164","to":""}}`
	...
	res = msg.GetSignBytes()
	expected = `{"type":"dip/MsgContract","value":{"amount":{"amount":"123","denom":"pdip"},"from":"nch1veex7mg3k0xqr","payload":"7061796c6f6164","to":"nch1w3hsls558e"}}`
	require.Equal(t, expected, string(res))
