...
func TestMsgSetNameGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"dipperBank/SetName","value":{"name":"maTurtle","owner":"cosmos1d4js690r9j","value":"1"}}`
...
func TestMsgBuyNameGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"dipperBank/BuyName","value":{"bid":[{"amount":"10","denom":"atom"}],` +
...
func TestMsgDeleteNameGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"dipperBank/DeleteName","value":{"name":"maTurtle","owner":"cosmos1d4js690r9j"}}`
