...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/Dipper-Labs/Dipper-Protocol/types/errors.Wrap",
		"github.com/Dipper-Labs/Dipper-Protocol/types/errors.Wrapf",
		"github.com/Dipper-Labs/Dipper-Protocol/types/errors.WithType",
